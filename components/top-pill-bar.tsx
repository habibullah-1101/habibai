...
export function TopPillBar({ left, center, right }: TopPillBarProps) {
  return (
    <div className="relative mx-auto flex h-14 w-full max-w-4xl items-center justify-between rounded-full border border-border/70 bg-background/90 px-4 shadow-border-small backdrop-blur-sm md:px-6">
